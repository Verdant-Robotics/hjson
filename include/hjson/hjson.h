...
public:
  enum Type { UNDEFINED, HJSON_NULL, BOOL, DOUBLE, STRING, VECTOR, MAP };
...
private:
  ...
  MapProxy(std::shared_ptr<ValueImpl> parent, std::shared_ptr<ValueImpl> child, const std::string& key);
